%% These packages are used for writing CUHK PhD thesis
% The packages are compatitable with the Xelatex with mixing CHINESE and ENGLISH writing and NOT compatitble with pddLatex
